...
This guide will help you set up **live Google Search Console (GSC)** integration for travelofareinfo.com. Once configured, you'll get **real-time data** from Google Search Console directly in your admin dashboard.
...
3. Enter your website: `https://travelofareinfo.com`
...
2. **Create New Project**
   ...
   - Project name: `travelofareinfo GSC`
   - Click "Create"
...
2. **Configure OAuth Consent Screen** (if prompted)
   ...
   - App name: `travelofareinfo Admin`
...
3. **Create OAuth Client ID**
   ...
   - Name: `travelofareinfo GSC Client`
...
2. **Add Google Credentials**
   ...
   GSC_SITE_URL=https://travelofareinfo.com
...
3. **For Production VPS, use production URL:**
   ```env
   GOOGLE_REDIRECT_URI=https://travelofareinfo.com/api/gsc/oauth2callback
   ```
...
3. Check that the site URL in GSC matches exactly: `https://travelofareinfo.com`
...
2. **Add Production URI to Google Cloud**
   ...
   - Add `https://travelofareinfo.com/api/gsc/oauth2callback`
...
**4. Test Connection:**
- Go to: https://travelofareinfo.com/admin/dashboard
- Click SEO tab
