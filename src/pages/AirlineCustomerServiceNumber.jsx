  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://travelofareinfo.com/airline-customer-service-number"
        />
        <meta
          property="og:title"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: "https://travelofareinfo.com/airline-customer-service-number",
            logo: "https://travelofareinfo.com/logo.svg",
            contactPoint: [
              {
                "@type": "ContactPoint",
                telephone: tfn,
