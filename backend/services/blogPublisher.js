...
class BlogPublisherService {
  ...
  async publishToMedium(blogPost) {
    ...
    const response = await axios.post(
      `https://api.medium.com/v1/users/${userId}/posts`,
      {
        ...
        canonicalUrl: `https://travelofareinfo.com/blog/${blogPost.slug}`
      },
      {
        headers: {
    ...
    const response = await axios.post(
      'https://dev.to/api/articles',
      {
        article: {
          ...
          canonical_url: `https://travelofareinfo.com/blog/${blogPost.slug}`,
  ...
  convertToMediumFormat(content) {
    ...
    return content + '\n\n---\n\n*Originally published at [travelofareinfo.com](https://travelofareinfo.com)*';
  }
        ...
        platforms: [
          {
            ...
            instructions: 'Copy content and paste. Add canonical URL to travelofareinfo.com',
            canonicalUrl: `https://travelofareinfo.com/blog/${blogPost.slug}`
          },
          {
            name: 'Dev.to',
          ...
          },
          {
            ...
            instructions: 'Write article, paste content, link back to travelofareinfo.com'
          },
          {
            name: 'Hashnode',
            da: 88,
